...
ENTRYPOINT ["java", "--class-path", "/app/main.war", "-Xmx2g", "-Dloader.path=main.war!/WEB-INF/classes/,main.war!/WEB-INF/,/app/extra-classes", "org.springframework.boot.loader.PropertiesLauncher", "app/main.war"]
